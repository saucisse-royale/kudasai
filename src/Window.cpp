...
void Window::initWindow() {
	...
	window = glfwCreateWindow(WIDTH, HEIGHT, "Kudasai", nullptr, nullptr);
...
/*static*/ void Window::onWindowResized(GLFWwindow* window, int width, int height) {
...
void Window::createInstance() {
	...
	appInfo.pApplicationName = "Kudasai";
...
void Window::createShaderModule(const std::vector<char>& code, VDeleter<VkShaderModule>& shaderModule) {
...
/*static*/ std::vector<char> Window::readFile(const std::string& filename) {
...
/*static*/ VKAPI_ATTR VkBool32 VKAPI_CALL Window::debugCallback(VkDebugReportFlagsEXT flags, VkDebugReportObjectTypeEXT objType, uint64_t obj, size_t location, int32_t code, const char* layerPrefix, const char* msg, void* userData) {
